...
while True:
    ...
    for k, v in stats.items():
        ...
        print("outer_sip: %s outer_dip: %s inner_sip: %s inner_dip: %s" % \
                (str(IPAddress(k.outer_sip)), str(IPAddress(k.outer_dip)), str(IPAddress(k.inner_sip)), str(IPAddress(k.inner_dip))))
